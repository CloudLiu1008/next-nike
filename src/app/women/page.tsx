  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl font-bold mb-8">女子</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-100 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">探索女子Nike鞋类产品</p>
              <a 
                href="/women/shoes" 
          ...
          <div className="bg-gray-100 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">探索女子Nike服装系列</p>
              <a 
                href="/women/clothing" 
                className="inline-block bg-black text-white px-6 py-2 rounded-full hover:bg-gray-800 transition-colors"
              >
          ...
          <div className="bg-gray-100 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">探索女子Nike配件系列</p>
              <a 
          ...
          <div className="bg-gray-100 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">专为各种运动设计的女子Nike产品</p>
              <a 
                href="/women/sports" 
                className="inline-block bg-black text-white px-6 py-2 rounded-full hover:bg-gray-800 transition-colors"
              >
          ...
          <div className="bg-gray-100 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">最受欢迎的女子Nike产品</p>
              <a 
